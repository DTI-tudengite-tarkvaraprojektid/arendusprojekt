    ...
    if(!empty($_POST)){
        ...
        if ($_POST["id"] != '') {
           ...
           "UPDATE Opilased   
            ...
            ");
            $stmt->bind_param('sssssssssssssssssssi',$_POST["lname"],$_POST["fname"],$_POST["idcode"],$_POST["email"],$_POST["email_school"],
            $_POST["student_id"],$_POST["field"],$_POST["spec"],$_POST["finance"],$_POST["unpaid"],$_POST["load"],$_POST["sem"],$_POST["break"],
            $_POST["abroad"],$_POST["finish"],$_POST["eap"],$_POST["kkh_ap"],$_POST["kkh_eap"],$_POST["kkh_all"],$_POST['id']);
            $stmt->execute();
            ...
            $stmt->bind_param('sssssssssssssssssss',$_POST["lname"],$_POST["fname"],$_POST["idcode"],$_POST["email"],$_POST["email_school"],
            $_POST["student_id"],$_POST["field"],$_POST["spec"],$_POST["finance"],$_POST["unpaid"],$_POST["load"],$_POST["sem"],$_POST["break"],
            $_POST["abroad"],$_POST["finish"],$_POST["eap"],$_POST["kkh_ap"],$_POST["kkh_eap"],$_POST["kkh_all"]);
            $done = $stmt->execute();
